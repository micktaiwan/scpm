...
class ToolsController < ApplicationController
  ...
  def sdp_yes_check
    ...
    @yes_but_no_task_requests = Request.find(:all, :conditions=>"sdp='yes' and sdpiteration!='2013' and sdpiteration!='2012' and sdpiteration!='2011-Y2' and sdpiteration!='2011' and sdpiteration!='2010' and request_id not in (#{@task_ids.join(',')})")
    @yes_but_cancelled_requests = Request.find(:all, :conditions=>"sdpiteration!='2013' and sdpiteration!='2012' and sdpiteration!='2011-Y2' and sdpiteration!='2011' and sdpiteration!='2010' and request_id in (#{@task_ids.join(',')}) and (status='cancelled' or status='removed')")
  ...
  def load_errors
    ...
    # TODO: not portable
    @checks = Request.find(:all, :conditions=>"status!='removed' and sdp='Yes' and sdpiteration!='' and sdpiteration!='2013' and sdpiteration!='2012' and sdpiteration!='2011-Y2' and sdpiteration!='2011' and sdpiteration!='2010'", :order=>"request_id")
