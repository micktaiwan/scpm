module SdpDB
  ...
  PhaseDB = { # name => [phase_id, proposal_id]
    ...
    ActivityDB = {
      ...
      # WP 1.6
      ['WP1.6.1 - DWQAP','WP1.6.1 - QWR DWQAP']=>143046,
      ['WP1.6.2 - Project Setting-up','WP1.6.2 - QWR Project Setting-up']=>143047,
      ['WP1.6.3 - WS Support, Reporting & KPI','WP1.6.3 - QWR Support, Reporting & KPI']=>143048,
      ['WP1.6.4 - Quality Status','WP1.6.4 - QWR Quality Status']=>143049,
      ['WP1.6.5 - Spiders','WP1.6.5 - QWR Spiders']=>143050,
      ['WP1.6.6 - QG BRD','WP1.6.6 - QWR QG BRD']=>143051,
      ['WP1.6.7 - QG TD','WP1.6.7 - QWR QG TD']=>143052,
      ['WP1.6.8 - Lessons Learnt','WP1.6.8 - QWR Lessons Learnt']=>143053,
      # WP 2
      ...
      ['All','WP3.3 - Modeling BAT specific Control']=>143058a,
