module SdpDB
  ...
  PhaseDB = { # name => [phase_id, proposal_id]
    ...
    'WP1.6.2 - QWR Project Setting-up' =>[32498,31244], #NEW
    'WP1.6.3 - QWR Support, Reporting & KP' =>[32498,31244], #NEW
    'WP1.6.4 - QWR Quality Status'          =>[32498,31244], #NEW
    'WP1.6.5 - QWR Spiders'                 =>[32498,31244], #NEW
    'WP1.6.6 - QWR QG BRD'                  =>[32498,31244], #NEW
    'WP1.6.7 - QWR QG TD'                   =>[32498,31244], #NEW
    'WP1.6.8 - QWR Lessons Learnt'          =>[32498,31244], #NEW
    ...
    "WP6.10.2 - Coaching Agility: Sprint 0 support"             => [32503,31250], #NEW
    "WP6.10.3 - Coaching Agility: Sprint coaching"              => [32503,31250], #NEW
    "WP7.1.1 - Expertise Activities for Multi Projects: Requirements Management"      => [32489,31568], #NEW
    "WP7.1.2 - Expertise Activities for Multi Projects: Risks Management"             => [32489,31568], #NEW
    "WP7.1.3 - Expertise Activities for Multi Projects: Test Management"              => [32489,31568], #NEW
    "WP7.1.4 - Expertise Activities for Multi Projects: Change Management"            => [32489,31568], #NEW
    "WP7.1.5 - Expertise Activities for Multi Projects: Lessons Learnt"               => [32489,31568], #NEW
    "WP7.1.6 - Expertise Activities for Multi Projects: Configuration Management"     => [32489,31568], #NEW
    "WP7.2.1 - Expertise Activities for Multi Projects: Requirements Management"      => [32504,31568], #NEW
    "WP7.2.2 - Expertise Activities for Multi Projects: Risks Management"             => [32504,31568], #NEW
    "WP7.2.3 - Expertise Activities for Multi Projects: Test Management"              => [32504,31568], #NEW
    "WP7.2.4 - Expertise Activities for Multi Projects: Change Management"            => [32504,31568], #NEW
    "WP7.2.5 - Expertise Activities for Multi Projects: Lessons Learnt"               => [32504,31568], #NEW
    "WP7.2.6 - Expertise Activities for Multi Projects: Configuration Management"     => [32504,31568]  #NEW
  }
