module SdpDB
  ...
  PhaseDB = { # name => [phase_id, proposal_id]
    ...
    'WP1.4 - Agility'          =>[0,0], #NEW
    'WP1.5 - SQR'              =>[0,0], #NEW
    'WP1.6.1 - DWQAP'          =>[0,0], #NEW
    'WP1.6.2 - Project Setting-up' =>[0,0], #NEW
    'WP1.6.3 - Support, Reporting & KP' =>[0,0], #NEW
    'WP1.6.4 – Quality Status'          =>[0,0], #NEW
    'WP1.6.5 – Spiders'                 =>[0,0], #NEW
    'WP1.6.6 – QG BRD'                  =>[0,0], #NEW
    'WP1.6.7 – QG TD'                   =>[0,0], #NEW
    'WP1.6.8 – Lessons Learnt'          =>[0,0], #NEW
    ...
    'WP3.2.1 - Business Process Layout'          => [0,0], #NEW
    'WP3.2.2 - Functional Layout (Use Cases)'    => [0,0], #NEW
    'WP3.2.3 - Information Layout (Data Model)'  => [0,0], #NEW
    ...
    'WP3.4 - Modeling BAT specific Production'   => [29247,28063],
	  ...
	  'WP4.3 - Actions Implementation & Control'   => [0,0], #NEW
	  'WP5 - Change Accompaniment'=>[29249,28065],
	  'WP5.1 - Change: Diagnosis & Action Plan'    => [0,0], #NEW
	  'WP5.2 – Change : Implementation Support & Follow-up' => [0,0], #NEW
	  ...
	  "WP6.6 – Change : Implementation Support & Follow-up" => [0,0], #NEW
	  "WP6.7 – Coaching Business Process"                   => [0,0], #NEW
	  "WP6.8 – Coaching Use Case"                           => [0,0], #NEW
	  "WP6.9 – Coaching Data Model"                         => [0,0], #NEW
	  "WP6.10.1 – Diagnosis & project launch"               => [0,0], #NEW
	  "WP6.10.2 – Sprint 0 support"                         => [0,0], #NEW
	  "WP6.10.3 – Sprint coaching"                          => [0,0], #NEW
	  "WP7.1.1 – Requirements Management"                   => [0,0], #NEW
	  "WP7.1.2 – Risks Management"                          => [0,0], #NEW
	  "WP7.1.3 – Test Management"                           => [0,0], #NEW
	  "WP7.1.4 – Change Management"                         => [0,0], #NEW
	  "WP7.1.5 – Lessons Learnt"                            => [0,0], #NEW
	  "WP7.1.6 – Configuration Management"                  => [0,0], #NEW
	  "WP7.2.1 – Requirements Management"                   => [0,0], #NEW
	  "WP7.2.2 – Risks Management"                          => [0,0], #NEW
	  "WP7.2.3 – Test Management"                           => [0,0], #NEW
	  "WP7.2.4 – Change Management"                         => [0,0], #NEW
	  "WP7.2.5 – Lessons Learnt"                            => [0,0], #NEW
	  "WP7.2.6 – Configuration Management"                  => [0,0]  #NEW  
	  }
