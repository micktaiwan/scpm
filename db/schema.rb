...
ActiveRecord::Schema.define(:version => 20130403150011) do
  ...
  create_table "statuses", :force => true do |t|
    ...
    t.text     "ws_report"
    t.datetime "reason_updated_at", :default => '2013-04-17 15:34:00'
    t.datetime "ws_updated_at",     :default => '2013-04-17 15:34:00'
    t.string   "file_link"
  end
